...
class PurchaseReport(models.Model):
    ...
    collecteur_id = fields.Many2one('optesis.collecteur', string='Collecteur')
    lieu_id = fields.Many2one('optesis.lieu', string='Lieu de Peche')
        ...
        select_str = """
            WITH currency_rate as (%s)
                SELECT
                    ...
                    po.collecteur_id as collecteur_id,
                    po.lieu_id as lieu_id,
                    po.user_id as user_id,
                    po.company_id as company_id,
                    po.fiscal_position_id as fiscal_position_id,
                    l.product_id,
                    l.section_frais as section_frais,
                    p.product_tmpl_id,
